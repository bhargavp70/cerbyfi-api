...
from app.scorer.fetchers import fetch_fund_data

_CONFIG_PATH = Path(__file__).parent.parent / "configs" / "scoring_config_index.json"
...
def score_fund(ticker: str) -> dict:
    config = _load_config()
    data   = fetch_fund_data(ticker.upper())
